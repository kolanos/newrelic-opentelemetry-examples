...
This branch contains an example of a modified version of the Appathon apps (available on `appathon` branch), where the dotnet app calls the Python app. A Collector has been set up in this example. 

## To run

1. `docker-compose up --build` 
2. Visit the dotnet app in the browser to generate traffic
3. Go to Jaeger to view the traces
